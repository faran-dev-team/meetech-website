            ...
            <div className="p-12 lg:p-16 ">
              ...
              <div className="mt-20 pt-12 border-t border-border-subtle flex flex-col sm:flex-row items-center justify-between gap-8">
                ...
                <div className="flex items-center gap-4">
                  <a href="mailto:info@meetechdevelopment.com" className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-bg-subtle hover:bg-border-subtle text-text-primary font-bold text-xs transition-all">
