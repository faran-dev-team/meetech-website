...
export default async function AdminContentPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-[#1E293B] mb-1">Content</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="inline-flex items-center px-4 py-2 bg-[#1E293B] text-[#F8FAFC] text-sm font-medium rounded-md hover:bg-gray-800 transition-colors"
              >
                Open Sanity Studio
                <svg
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border border-gray-200 rounded-md p-4">
                <h3 className="text-sm font-semibold text-[#1E293B] mb-2">Content Blocks</h3>
                <p className="text-xs text-gray-600 mb-3">
              ...
              <div className="border border-gray-200 rounded-md p-4">
                <h3 className="text-sm font-semibold text-[#1E293B] mb-2">Media Assets</h3>
                <p className="text-xs text-gray-600 mb-3">
